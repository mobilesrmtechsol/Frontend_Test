...
/*
       ...
       Description: This class is used to show the Post List from server and delete the specific Post.
*/
class PostList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: Builder(
        builder: (context) =>
            Scaffold(appBar: AppBar(title: const Text('Post List'),
  ...
  class PostListPageState extends State<PostListPage> {
        ...
        /*
            CreatedBy: Ankit Agrahari
            CreatedDate: 15/04/2022
            Description: This method used to navigate to Post Detail screen.
        */
        ...
        /*
            CreatedBy: Ankit Agrahari
            CreatedDate: 15/04/2022
            Description: This method used to fetch Post List from API.
        */
        ...
        /*
            CreatedBy: Ankit Agrahari
            CreatedDate: 15/04/2022
            Description: This method used to show confirmation dialog before deleting the post from Post List
        */
        ...
        /*
            CreatedBy: Ankit Agrahari
            CreatedDate: 15/04/2022
            Description: This method used to call the delete API and delete the Post from List.
        */
